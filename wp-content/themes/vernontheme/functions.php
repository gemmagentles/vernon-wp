...
// HTML5 Blank navigation for logout
function html5blank_nav_logout()
{
    wp_nav_menu(
        array(
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'header-menu-logout' => __('Logout Menu', 'html5blank') // Logout Navigation if needed (duplicate as many as you need!)
    ));
}
...
function products_page_heading_action() {
    get_template_part('partials/centered-text-products');
}
